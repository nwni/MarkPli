...
<div class="container">
    ...
    <?php echo form_open(base_url('events/save')) ?>
      ...
      <!--      <div class='col-md-6'>
                <div class="form-group">
                    <div class='input-group date' id='from'>
                        ...
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div class="form-group">
                                 <label clas for="Tipo_usuario">Tipo de post:</label>
                                          <div class="col-sm-12">
                                            <select name="txtTipo_usuario" class="form-control" id="Tipo_usuario">
        ...
        <!--     <div class="form-group">
                <label class="col-sm-12 control-label">Tipo de Post</label>
                <div class="col-sm-12">
              ...
              <div class="form-group">
                <label for="url" class="col-sm-12 control-label">Tags</label>
                <div class="col-sm-12">
                  <input type="text" name="tags" class="form-control" id="tags" placeholder="Introduce los tags">
                </div>
            </div>

            <div class="form-group">
                <label for="url" class="col-sm-12 control-label">Hashtag</label>
                <div class="col-sm-12">
                  <input type="text" name="Hashtag" class="form-control" id="Hashtag" placeholder="Introduce los Hashtag">
                </div>
            </div>

            <div class="form-group">
                <label for="title" class="col-sm-12 control-label">Descripcion</label>
                <div class="col-sm-12">
                  <input type="text" name="Descripcion" class="form-control" id="Descripcion" placeholder="Introduce una descripcion">
                </div>
            </div>
