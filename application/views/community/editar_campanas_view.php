<?php 
 ...
 <div class="container" align="center">
 	<h1>Modificar Campaña</h1>

 		<form class="form-horizontal"  method="POST"  action="<?php echo base_url();?>Campanas/editarEnlace/<?=$id_campana?>">

 			  <div class="form-group">
 			    <label  class="col-lg-2 control-label">Nombre Campaña</label>
					<div class="col-lg-10">
 			  		<input type="text" class="form-control" name="txtnombre_campana" placeholder="Ingrese el nombre de la Campaña" required="" value="<?=$nombre_campana?>">
 				</div>
 				 </div>
 			  ...
 			  <div class="form-group">
 			    <label  class="col-lg-2 control-label">Descripcion</label>
					<div class="col-lg-10">
 			  		<input type="text" class="form-control" name="txtdescripcion" placeholder="Ingrese la descripcion de la campaña" required="" value="<?=$descripcion?>">
 				</div>
 				 </div>
 			  ...
 			  <div class="form-group">
 			    <label  class="col-lg-2 control-label">Objetivos Campaña</label>
					<div class="col-lg-10">
 			  		<input type="text" class="form-control" name="txtobjetivos" placeholder="Ingrese los objetivos de la campaña" required="" value="<?=$objetivos?>">
 				</div>
 				 </div>
 			...
 			<div class="form-group">
 			  ...
 			  <div class="form-group">
 			    <div class=" col-lg-12">
 			      <button type="submit" class="btn btn-default">Modificar Campaña</button>
 			    </div>
 			  </div>
